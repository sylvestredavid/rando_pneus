...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["pages-edit-fiche-edit-fiche-module"], {
  ...
  function srcAppPagesEditFicheEditFichePageTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var ng_lz_string__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(
    /*! ng-lz-string */
    "./node_modules/ng-lz-string/ng-lz-string.umd.js");
    /* harmony import */


    var ng_lz_string__WEBPACK_IMPORTED_MODULE_10___default = /*#__PURE__*/__webpack_require__.n(ng_lz_string__WEBPACK_IMPORTED_MODULE_10__);
    /* harmony import */
    ...
    var EditFichePage = /*#__PURE__*/function () {
      function EditFichePage(formBuilder, route, router, events, alertCtrl, camera, base64, utilsService, loadingCtrl, actionSheetController, lz, file, afStorage, ficheFirebaseService) {
      ...
      _createClass(EditFichePage, [{
        ...
        value: function getFiche(id) {
          ...
          this.subrcisption = this.ficheFirebaseService.fiches$.subscribe(function (fiches) {
            _this.fiche = fiches.find(function (f) {
              return f.id === id;
            });
            _this.photos = _this.fiche.photos ? _this.fiche.photos : [];

            _this.constructFourni();

            _this.fiche.vue = true;
            _this.fiche.modifieParBureau = false;

            _this.ficheFirebaseService.updateFiche(_this.fiche);
        ...
        value: function initForm() {
          ...
          setTimeout(function () {
            _this2.signatureClient.signaturePad.fromDataURL(_this2.fiche.signatureClient);

            _this2.signatureResponsable.signaturePad.fromDataURL(_this2.fiche.signatureResponsable);
          }, 1000);
        }
      }, {
        key: "calculTime",
                ...
                switch (_context3.prev = _context3.next) {
                  ...
                  case 5:
                    ...
                    reader.onload = function () {
                      ...
                      _this6.afStorage.ref('photos/' + localStorage.getItem('userId') + '/' + name).put(imgBlob).then(function (ok) {
                        _this6.afStorage.ref(ok.metadata.fullPath).getDownloadURL().subscribe(function (path) {
                          _this6.photos.push({
                            nom: name,
                            data: path
                          });
                  ...
                  case 0:
                    ...
                    return this.alertCtrl.create({
                      ...
                      buttons: [{
                        text: 'Valider',
                        handler: function handler() {
                          _this7.afStorage.storage.refFromURL(_this7.photos[i].data)["delete"]();

                          _this7.photos.splice(i, 1);
                        }
                      }, {
                        text: 'Annuler'
                      }],
        ...
        value: function openMapAPP() {
          new _ionic_native_launch_navigator_ngx__WEBPACK_IMPORTED_MODULE_13__["LaunchNavigator"]().navigate(this.ficheForm.value.nomAdresse);
        }
      }, {
        key: "ngOnDestroy",
    ...
    EditFichePage.ctorParameters = function () {
      return [{
        ...
        type: ng_lz_string__WEBPACK_IMPORTED_MODULE_10__["LZStringService"]
      }, {
