...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["common"], {
  ...
  /***/
  function srcAppServicesFichesServiceTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "FicheService", function () {
      return FicheService;
    });
    /* harmony import */
    ...
    var FicheService = /*#__PURE__*/function () {
      ...
      _createClass(FicheService, [{
        ...
        value: function getFiches() {
          var arr = [];
          return this.storage.forEach(function (value, key, index) {
        ...
        value: function getFiche(id) {
          return this.storage.get('fiche' + id).then(function (val) {
            return val;
          })["catch"](this.handleError);
        }
      }, {
        key: "sendFiche",
        value: function sendFiche(fiche) {
        ...
        key: "create",
        value: function create(fiche, callback) {
          var _this2 = this;

          this.storage.ready().then(function () {
            _this2.storage.get('i').then(function (val) {
              var i = val + 1; // set l'id de la fiche

              fiche.id = i;

              _this2.storage.set('fiche' + i, fiche);

              _this2.storage.set('i', i);
        ...
        key: "presentAlert",
        value: function presentAlert(title, subTitle, ficheClean, isSended) {
                    ...
                    return this.alertCtrl.create({
                      ...
                      buttons: [{
                        ...
                        handler: function handler() {
                          if (isSended) {
                            _this3.events.publish('ficheEnvoyed', {});
                          }
                        }
                      }]
                    });
    ...
    FicheService.ctorParameters = function () {
      return [{
        type: _events__WEBPACK_IMPORTED_MODULE_4__["Events"]
      }, {
    ...
    FicheService = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Injectable"])({
      providedIn: 'root'
    })], FicheService);
    /***/
  },
  ...
  function srcAppServicesUtilsServiceTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var UtilsService = /*#__PURE__*/function () {
      ...
      _createClass(UtilsService, [{
        key: "calculTime",
        value: function calculTime(ficheForm) {
          if (ficheForm.get('depart').value !== '' && ficheForm.get('arrive').value !== '') {
            var arrive = new Date(ficheForm.get('arrive').value);
            var depart = new Date(ficheForm.get('depart').value);
            arrive.setSeconds(0, 0);
            depart.setSeconds(0, 0);
            var diff = depart.getTime() - arrive.getTime();
            var heures = Math.floor(diff / (1000 * 60 * 60));
            var minutes = Math.floor(diff / (1000 * 60)) - heures * 60;
        ...
        key: "formatTempsPasse",
        value: function formatTempsPasse(dataTime, initial) {
          var unit = dataTime;
