...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["pages-nouvelle-fiche-nouvelle-fiche-module"], {
  ...
  function srcAppPagesNouvelleFicheNouvelleFichePageTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var ng_lz_string__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(
    /*! ng-lz-string */
    "./node_modules/ng-lz-string/ng-lz-string.umd.js");
    /* harmony import */


    var ng_lz_string__WEBPACK_IMPORTED_MODULE_14___default = /*#__PURE__*/__webpack_require__.n(ng_lz_string__WEBPACK_IMPORTED_MODULE_14__);

    var NouvelleFichePage = /*#__PURE__*/function () {
      function NouvelleFichePage(formBuilder, ficheService, userService, router, events, alertCtrl, camera, base64, utilsService, actionSheetController, loadingCtrl, file, lz, afStorage, ficheFirebaseService) {
        var _this = this;
    ...
    NouvelleFichePage.ctorParameters = function () {
      return [{
        ...
        type: ng_lz_string__WEBPACK_IMPORTED_MODULE_14__["LZStringService"]
      }, {
