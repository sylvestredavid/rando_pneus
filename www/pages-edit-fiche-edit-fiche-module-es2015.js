...
/* harmony import */ var ng_lz_string__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ng-lz-string */ "./node_modules/ng-lz-string/ng-lz-string.umd.js");
/* harmony import */ var ng_lz_string__WEBPACK_IMPORTED_MODULE_10___default = /*#__PURE__*/__webpack_require__.n(ng_lz_string__WEBPACK_IMPORTED_MODULE_10__);
...
let EditFichePage = class EditFichePage {
    constructor(formBuilder, route, router, events, alertCtrl, camera, base64, utilsService, loadingCtrl, actionSheetController, lz, file, afStorage, ficheFirebaseService) {
        ...
        return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(this, void 0, void 0, function* () {
            ...
            reader.onload = () => {
                ...
                this.afStorage.ref('photos/' + localStorage.getItem('userId') + '/' + name)
                    .put(imgBlob)
                    .then((ok) => {
                    this.afStorage.ref(ok.metadata.fullPath).getDownloadURL().subscribe(path => {
                        this.photos.push({
                            nom: name,
                            data: path
                        });
