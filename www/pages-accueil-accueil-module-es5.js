...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["pages-accueil-accueil-module"], {
  ...
  function srcAppPagesAccueilAccueilRoutingModuleTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var AccueilPageRoutingModule = function AccueilPageRoutingModule() {
      _classCallCheck(this, AccueilPageRoutingModule);
    };

    AccueilPageRoutingModule = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
  ...
  function srcAppPagesAccueilAccueilModuleTs(module, __webpack_exports__, __webpack_require__) {
    ...
    AccueilPageModule = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
  ...
  function srcAppPagesAccueilAccueilPageTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var AccueilPage = /*#__PURE__*/function () {
      function AccueilPage(router) {
      ...
      _createClass(AccueilPage, [{
        ...
        key: "mesFiches",
        value: function mesFiches() {
          this.router.navigate(['fiche']); // this.menu.swipeEnable(true);
        }
      }, {
        key: "reglages",
        value: function reglages() {
          this.router.navigate(['reglage']); // this.menu.swipeEnable(true);
        }
      }, {
        key: "nouvelleFiche",
        value: function nouvelleFiche() {
          this.router.navigate(['nouvelle-fiche']); // this.menu.swipeEnable(true);
        }
      }]);
    ...
    AccueilPage = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
